...
namespace EmployeeInformations.Model.EmployeesViewModel
{
    public class Employees
    {
        ...
        public List<RelievingReasonEntity> RelievingReasonEntity { get; set; }
        public DateTime? ReleavedDate { get; set; }
        public List<RelievingReasons> RelievingReasons { get; set; }
        public List<EmployeesDetailsDataModel>? EmployeesDetailsDataModels { get; set; }
