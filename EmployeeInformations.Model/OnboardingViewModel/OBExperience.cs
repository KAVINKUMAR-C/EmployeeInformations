...
namespace EmployeeInformations.Model.OnboardingViewModel
{
     public class OBExperience
    {
        ...
        public List<OBExperienceAttachment> ExperienceAttachment { get; set; }

        // Datetime issue
        public string StrDateOfJoining { get; set; }
        public string StrDateOfRelieving { get; set; }
    }
    public class OBExperienceAttachment
    {
    ...
    public class OBExperienceDocumentFilePath
    {
        public string ExperienceName { get; set; }
        public string Document { get; set; }
        public int EmpId { get; set; }
